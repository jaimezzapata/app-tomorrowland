  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-2xl border-2 border-slate-200 hover:shadow-blue-500/20 hover:border-consciencia-blue/50 transition-all duration-300 transform hover:-translate-y-1 group">
      ...
      <div>
        ...
        <p className="text-base text-slate-700 font-semibold flex items-center gap-2 mb-4">
        ...
        <button
          ...
          className={`w-full flex items-center justify-center gap-2 py-2 rounded-lg transition-all duration-200 font-bold text-sm ${
            pinned 
